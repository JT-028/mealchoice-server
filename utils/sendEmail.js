...
export const sendPasswordResetEmail = async ({ to, name, resetToken }) => {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>Hi ${name},</p>
      <p>We received a request to reset your password for your MealChoice account. Click the button below to set a new password:</p>
  ...
  await sendEmail({
    to,
    subject: "Reset Your MealChoice Password",
    html,
  });
};
